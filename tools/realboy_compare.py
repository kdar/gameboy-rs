...
child1 = pexpect.spawn('target/debug/gameboy-emu "res/cpu_instrs/individual/06-ld r,r.gb" --debug')
child2 = pexpect.spawn('/home/outroot/build/realboy-0.2.2/src/realboy -d "res/cpu_instrs/individual/06-ld r,r.gb"')
